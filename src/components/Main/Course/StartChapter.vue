<template>
  <div class="chapter-wrapper">
    <div v-if="!step" class="blur-modal">
      Привет. <br />
      Добро пожаловать на работу! Давайте начнём день с плана на смену. Посмотрите видео и узнайте,
      что ждёт впереди.
    </div>
    <div v-if="step === 1" class="blur-modal">
      Первая поездка вот-вот начнётся. <br />
      Давайте разберёмся с тем, как правильно приветствовать пассажиров разного возраста и пола.
      Зная это, вы сможете правильно установить контакт с пассажиром с самого начала поездки.
    </div>
    <div v-if="step === 2" class="blur-modal">
      Пассажиры могут попасться любого возраста. К каждому есть отдельное обращение, чтобы звучать
      корректно и вежливо.<br />
